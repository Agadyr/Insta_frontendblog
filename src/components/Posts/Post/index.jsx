        ...
        <div className="container">
            {(step == 1 || step == 2) && <div className="user-profile">
                <div className="nav-menu">
                        ...
                        <img src={item.imageprofile} alt="" id="imageprofile"/>
                </div>
                <div className="headerofProfile df jcsb aic">
                    ...
                    <div className="header-navigation df aic">
                        ...
                        <FontAwesomeIcon icon={faSquarePlus} className="icon" onClick={()=> setstep(2)}/>
                ...
                <div className="aboutuser df aic">
                    <div className="userprofilephoto">
                        <img src={item.userposts.postimage2} alt="Not found" id="userphoto" />
                    </div>
                    <div className="stateuser">
                        ...
                        <div className="states df">
                            <div className="states-item df"><h2>{item.stats.posts} </h2>posts</div>
                            <div className="states-item df"><h2>{item.stats.followers}</h2>followers</div>
                            <div className="states-item df"><h2>{item.stats.following} </h2>following</div>
                        </div>
                        <div className="bio">
                            <h2>{item.bio}</h2>
                        </div>
                ...
                <div className="posts">
                    ...
                    <div className="posts-images">
                        <img src={item.userposts.postimage1} alt="" />
                        <img src={item.userposts.postimage2} alt="" />
                        <img src={item.userposts.postimage3} alt="" />
                        <img src={item.userposts.postimage4} alt="" />
                        <img src={item.userposts.postimage5} alt="" />
                        <img src={item.userposts.postimage6} alt="" />
                        <img src={item.userposts.postimage7} alt="" />
                        <img src={item.userposts.postimage8} alt="" />
                        <img src={item.userposts.postimage9} alt="" />
                    </div>
                </div>
            </div>}
            {step == 2 && <ModalWindow onClose={closeModal}/>}
        </div>
    )
}