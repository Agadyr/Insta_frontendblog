...
export default function ModalWindow({closeModal}){
    ...
    return(
        <div className="main-window" style={{zIndex:999}}>
                ...
                <div className="all-img">
                    ...
                    <div className="about-post">
                        ...
                        <div className="caption">
                            <textarea rows="10" placeholder="Write Caption" onChange={e => SetCountValue(e.target.value)}></textarea>
                            <FontAwesomeIcon icon={faSmile} className="smile" onClick={handleClose}/>
                            <div className="count">
                                <h2>{ countValue.length }</h2> <h2>/ 2,200</h2>
                            </div>
                        </div>
                    </div>
                </div>  
