...
export default function ModalWindow({onClose}){
    ...
    // Создаем временную ссылку на выбранный файл для предварительного просмотра
    ...
    const wordcount = countValue.length 
        ...
        <div className="main-window">
            ...
            {step== 1 && <div className="Modal-window">
                ...
                <div className="load">
                    ...
                    <input type="file" accept=".png, .jpg, .jpeg" onChange={handleFileChange} placeholder="Select from Computer" className="btn selectimage-btn" />
                </div>
            </div>}
            {step == 2 && 
                ...
                <div className="all-img">
                    ...
                    <div className="about-post">
                        ...
                        <div className="caption">
                            <textarea rows="10" placeholder="Write Caption" onChange={handleInputChange}></textarea>
                            <FontAwesomeIcon icon={faSmile} className="smile" onClick={handleClose}/>
                            <div className="count">
                                <h2>{wordcount}</h2><h2>/ 2,200</h2>
                            </div>
                        </div>
                    </div>
                </div>  
